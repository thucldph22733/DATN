$(document).ready(function () {
    $("#basic-alert").on("click", function () {
        ...
        Swal.fire({
            ...
            if (result.value) {
                // Xác định URL xóa dựa trên nút nhấn
                const deleteUrl = document.getElementById("deleteButton").getAttribute("href");

                // Gửi yêu cầu GET để xóa mục
                fetch(deleteUrl, {
                    method: 'GET'
                }).then(response => {
                    if (response.ok) {
                        ...
                        // Thực hiện bất kỳ cập nhật giao diện nào bạn cần ở đây
                    } else {
